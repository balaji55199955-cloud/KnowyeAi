...
Extract each food, beverage, or exercise. Estimate accurate nutritional values.
...
{"summary":"1-2 sentence friendly summary","items":[{"name":"Food name","category":"Breakfast","calories":250,"protein":12,"carbs":30,"fat":8,"amount":"1 bowl","isExercise":false,"micros":{"sodium":200,"potassium":300,"calcium":50,"iron":2,"vitaminC":5}}]}`;
    ...
    console.error("Error in /api/parse-journal:", error?.message);
